...
* **ASN.1 encoding/decoding** of NGAP/RRC messages
* **Standards-compliant 5G signaling** without RF hardware
...
1. **GitHub Demo**: [srsRAN Multi-UE Setup](https://github.com/devopsjourney23/my-srsproject-demo)
2. **Official Documentation**: [srsRAN Project Docs](https://docs.srsran.com/projects/project/en/latest/tutorials/source/srsUE/source/index.html#multi-ue-emulation)
...
* ✔ **Multi-UE paging** with real-time monitoring
* ✔ **ASN.1 encoder/decoder** for standards compliance
* ✔ **PCAP analysis** with Wireshark verification
* ✔ **Automated testing** capabilities
* ✔ **Production-grade** 5G signaling
* ✔ **Research-ready** platform for 5G NR studies
